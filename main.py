...
def main(args):
    ...
    if config.model == 'Lip2C2F':
        ...
        config.loss = 'xent'
        config.scale = 'small'
    elif config.model == 'Sandwich2C2F':
        config.layer = 'Sandwich2C2F'
        config.loss = 'xent'
        config.scale = 'small'
        ...
        config.loss = 'xent'
        config.scale = 'small'
    elif config.model == 'Lip4C3F':
        config.layer = 'Lip4C3F'
        config.loss = 'xent'
        config.scale = 'small'
    elif config.model == 'Vanilla4C3F':
        config.layer = 'Vanilla4C3F'
        config.loss = 'xent'
        config.scale = 'small'
        ...
        config.loss = 'xent'
        config.scale = 'small'
    elif config.model == 'Lip6C2F':
        config.layer = 'Lip6C2F'
        config.loss = 'xent'
        config.scale = 'small'
    elif config.model == 'LipFNN':
        config.layer = 'LipFNN'
        config.loss = 'xent'
        config.scale = 'small'
    elif config.model == 'LipCNN':
        config.layer = 'LipCNN'
        config.loss = 'xent'
        config.scale = 'small'
    elif config.model == 'CNNcomp':
        config.layer = 'CNNcomp'
        config.loss = 'xent'
        config.scale = 'small'
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--model', type=str, default='All2C2F',
                        help="[Lip2C2F, Lip4C3F, Lip6C2F, LipFNN, All2C2F, AllLeNet5, LipLeNet5Max, LipCNN, DNN, KWL, Resnet, Toy]")
    parser.add_argument('-d', '--dataset', type=str, default='mnist',
                        help="dataset [mnist, cifar10, cifar100, tiny_imagenet, square_wave]")
